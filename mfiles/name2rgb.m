% name2rgb.m: translates a colour from multiple formats into matlab colour format
% type 'name2rgb demo' to get started
%
% [matlabcolor]=name2rgb(col)
...
%			(type 'name2rgb list' or 'name2rgb demo' to see them all)
%
...
elseif isa(in,'char')
	if strcmp(in,'demo') name2rgb_demo; return; end
	if strcmp(in,'list') name2rgb_list; return; end
